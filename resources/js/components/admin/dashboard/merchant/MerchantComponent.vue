    ...
    <div class="col-12 xl:col-12">
        <div class="db-card">
            ...
            <div class="db-card-body">
                <MerchantDashboardStatsComponent :dashboadStats="dashboadStats" />
...
import MerchantDashboardStatsComponent from "./MerchantDashboardStatsComponent";
...
export default {
    ...
    components: {
        LoadingComponent,
        Datepicker,
        MerchantDashboardStatsComponent,
        highcharts: Chart
    },
    data() {
        return {
    ...
    methods: {
        customerStates: function (e) {
            ...
            this.$store.dispatch("dashboard/merchantTrends", date).then((res) => {
                var series = []
                var categories = []
            ...
            this.$store.dispatch("dashboard/getTopShoppers", date).then((res) => {
                var series = []
                var categories = []
            ...
            this.$store.dispatch("dashboard/getMerchantTransactionByGender", date).then((res) => {
            ...
            this.$store.dispatch("dashboard/getMerchantStats", date).then((res) => {
