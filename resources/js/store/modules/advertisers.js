    ...
    actions: {
        ...
        save: function (context, payload) {
            return new Promise((resolve, reject) => {
                ...
                let url = "/admin/advertisers";
                if (this.state["advertisers"].temp.isEditing) {
                    method = axios.put;
                    url = `/admin/advertisers/${this.state["advertisers"].temp.temp_id}`;
                }
        ...
        destroy: function (context, payload) {
            return new Promise((resolve, reject) => {
                axios.delete(`admin/advertisers/${payload.id}`).then((res) => {
                    context.dispatch("lists", payload.search).then().catch();
                    resolve(res);
                }).catch((err) => {
                    reject(err);
        ...
        show: function (context, payload) {
            return new Promise((resolve, reject) => {
                axios.get(`admin/advertisers/show/${payload}`).then((res) => {
        ...
        export: function (context, payload) {
            return new Promise((resolve, reject) => {
                let url = 'admin/advertisers/export';
                if (payload) {
                    url = url + appService.requestHandler(payload);
                }
        ...
        changePassword: function (context, payload) {
            return new Promise((resolve, reject) => {
                axios.post(`/admin/advertisers/change-password/${payload.id}`, payload.form).then((res) => {
                    resolve(res);
                }).catch((err) => {
                    reject(err);
                });
        ...
        changeImage: function (context, payload) {
            return new Promise((resolve, reject) => {
                axios.post(`/admin/advertisers/change-image/${payload.id}`, payload.form, {
                        headers: {
        ...
        myOrders: function (context, payload) {
            return new Promise((resolve, reject) => {
                let url = `admin/advertisers/my-order/${payload.id}`;
                if (payload.search) {
