...
Route::prefix('auth')->middleware(['installed', 'apiKey', 'localization'])->name('auth.')->namespace('Auth')->group(function () {
    ...
    Route::post('/mobile-search', [LoginController::class, 'customerByMobile']);
...
Route::prefix('admin')->name('admin.')->middleware(['installed', 'apiKey', 'auth:sanctum', 'localization'])->group(function () {
    ...
    Route::prefix('billers')->name('my-order.')->group(function () {
        Route::get('airtime-operators', [BillController::class, 'airtimeOperators']);
        Route::get('data-operators', [BillController::class, 'dataOperators']);
